...
function HomePage({ user }) {
    const { products, categories, cart } = useApp()
        ...
        <div className="app">
            <header className="header">
                ...
                <nav className={`mobile-nav ${mobileMenuOpen ? 'open' : ''}`}>
                    <Link to="/" className="nav-link" onClick={() => setMobileMenuOpen(false)}>🏠 Shop</Link>
                    <Link to="/cart" className="nav-link" onClick={() => setMobileMenuOpen(false)}>🛒 Cart ({cartCount})</Link>
